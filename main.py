...
if __name__ == '__main__':
    if input('Do you want to run the scraper? (y/n): ').lower() == 'y':
        ...
        Scraper(fundamentus_url, f'Fundamentus_{date.today()}.csv').generate_csv()
