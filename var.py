...
options = f"""{BOLD}{BLUE}[{WHITE} 1 {BLUE}]{WHITE} - Create table{ENDC}
{BOLD}{BLUE}[{WHITE} 2 {BLUE}]{WHITE} - Insert data{ENDC}
{BOLD}{BLUE}[{WHITE} 3 {BLUE}]{WHITE} - Delete table{ENDC}
{BOLD}{BLUE}[{WHITE} 4 {BLUE}]{WHITE} - Show tables{ENDC}
{BOLD}{BLUE}[{WHITE} 5 {BLUE}]{WHITE} - View table{ENDC}
{BOLD}{BLUE}[{WHITE} 6 {BLUE}]{WHITE} - Show table fields{ENDC}
{BOLD}{BLUE}[{WHITE} 7 {BLUE}]{WHITE} - View field(s){ENDC}
{BOLD}{BLUE}[{WHITE} 0 {BLUE}]{WHITE} - Exit{ENDC}"""
